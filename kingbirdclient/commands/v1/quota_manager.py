...
class QuotaDetail(base.KingbirdLister):
    ...
    def get_parser(self, parsed_args):
        parser = super(QuotaDetail, self).get_parser(parsed_args)
...
class QuotaSync(command.Command):
    """On Demand quota sync for a tenant."""

    def get_parser(self, prog_name):
        parser = super(QuotaSync, self).get_parser(prog_name)
