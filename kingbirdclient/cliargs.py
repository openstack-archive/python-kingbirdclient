...
from kingbirdclient.common.i18n import _
from kingbirdclient.common import sdk
...
def add_global_identity_args(parser):
    ...
    verify_group.add_argument(
        ...
        help=_('Path of CA TLS certificate(s) used to verify the remote '
               'server\'s certificate. Without this option kingbird looks '
    ...
    verify_group.add_argument(
        ...
        help=_('Explicitly allow kingbirdclient to perform "insecure SSL" '
...
def add_global_args(parser, version):
    ...
    parser.add_argument(
        ...
        default=bool(utils.env('KINGBIRDCLIENT_DEBUG')),
        help=_('Defaults to env[KINGBIRDCLIENT_DEBUG].'))
    ...
    parser.add_argument(
        '--kingbird-api-version',
        default=utils.env('KINGBIRD_API_VERSION', default='1'),
        help=_('Version number for Kingbird API to use, Default to "1".'))
