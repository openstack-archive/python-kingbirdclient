...
class TestCLISyncManagerV1(base.BaseCommandTest):
    ...
    def test_template_resource_sync_invalid_extension(self):
        self.assertRaises(
            exceptions.TemplateError, self.call, sync_cmd.TemplateResourceSync, app_args=['--template', 'test_template.yzx'])
    ...
    def test_template_resource_sync_source_missing_yaml(self):
        ...
        with open('test_source_missing_template.yaml', 'w') as f:
            ...
            f.close()
        self.assertRaises(
            exceptions.TemplateError, self.call, sync_cmd.TemplateResourceSync, app_args=['--template', 'test_template.yaml'])
